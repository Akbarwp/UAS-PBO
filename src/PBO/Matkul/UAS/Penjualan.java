...
public class Penjualan extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        txDiskon = new javax.swing.JLabel();
        ...
        txDiskon.setFont(new java.awt.Font("Roboto", 1, 18)); // NOI18N
        txDiskon.setForeground(new java.awt.Color(8, 76, 77));
        txDiskon.setText("Diskon");
        ...
        tbTransaksi.setBackground(new java.awt.Color(255, 255, 255));
        ...
        tbDetail.setBackground(new java.awt.Color(255, 255, 255));
        ...
        txID1.setBackground(new java.awt.Color(255, 255, 255));
        ...
        tabPenjualan.addTab("Tabel Transaksi", jPanel4);
    ...
    private void tbTransaksiMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbTransaksiMouseClicked
        ...
        if (evt.getClickCount() == 2) {
            ...
            if (Integer.parseInt(txTotal.getText()) > 200000) {
                txDiskon.setText("20%");
            } else if (Integer.parseInt(txTotal.getText()) <= 200000) {
                txDiskon.setText("-");
            }
        }
    ...
    private javax.swing.JLabel txDiskon;
