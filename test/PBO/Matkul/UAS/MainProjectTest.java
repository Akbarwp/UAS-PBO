...
public class MainProjectTest {
    ...
    public void testPegawai() {
        ...
        win.robot.enterText("31-12-2001");win.robot.moveMouse(500, 473);
        win.robot.pressMouse(MouseButton.LEFT_BUTTON);
        win.robot.releaseMouse(MouseButton.LEFT_BUTTON);
    ...
    public void testPenjualan() {
        ...
        win.comboBox("cbNamaPegawai1").selectItem("Eka");
        win.comboBox("cbNamaPelanggan1").selectItem("Cahyo");
        win.radioButton("rbMembrane1").click();
        win.comboBox("cbUkuranBarang1").selectItem("TKL");
        win.comboBox("cbNamaBarang1").selectItem("Sades Sabre");
        ...
        win.comboBox("cbNamaPelanggan").selectItem("Agus");
    ...
    public void testPembayaran() {
        ...
        win.textBox("txBayar1").enterText("300000");
        win.button("btnTambahData").click();
        win.optionPane().requireMessage("Success");
        win.optionPane().okButton().click();
        ...
        win.textBox("txBayar").enterText("200000");
        win.button("btnUpdate").click();
        win.optionPane().requireMessage("Success");
        win.optionPane().okButton().click();
